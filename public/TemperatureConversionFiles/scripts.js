...
function celsiusOutput() {
  ...
  document.getElementById("CtoF").innerHTML =
    Math.round(inputVal * 1.8 + 32) + "°F";
  document.getElementById("CtoK").innerHTML =
    Math.round(parseInt(inputVal) + 273.15) + "K";
}
...
function fahrenheitOutput() {
  ...
  document.getElementById("FtoC").innerHTML =
    Math.round((inputVal - 32) / 1.8) + "°C";
  document.getElementById("FtoK").innerHTML =
    Math.round((parseInt(inputVal) - 32) / 1.8 + 273.15) + "K";
}
...
function kelvinOutput() {
  ...
  container.innerHTML = `
   ...
   `;
  document.getElementById("KtoF").innerHTML =
    Math.round((parseInt(inputVal) - 273.15) * 1.8 + 32) + "°F";
  document.getElementById("KtoC").innerHTML =
    Math.round(parseInt(inputVal) - 273.15) + "C";
}
