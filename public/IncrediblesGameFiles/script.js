...
function createGrid() {
  ...
  incredible_squares = Array.from(
    document.querySelectorAll(".mrIncredible div")
  );
}
  ...
  if (!shooted) {
    ...
    function Movebasketball() {
      if (basketball_squares[current_basketball_position]) {
        basketball_squares[current_basketball_position].classList.remove(
          "Basketball_bg"
        );
      }
      ...
      if (current_basketball_position > 3) {
        basketball_squares[current_basketball_position].classList.add(
          "Basketball_bg"
        );
...
function GameOver() {
  ...
  var Interaction_Buttons = Array.from(
    document.querySelectorAll(".Interaction_Buttons")
  );
