...
function createResetButton() {
	...
	resetButton.classList.add("input_reset");
	resetButton.style.backgroundColor = themes[currentTheme].secondary_color;
	resetButton.style.color = themes[currentTheme].primary_color;
	let main_container = document.getElementsByClassName("main_container")[0];
	main_container.appendChild(resetButton);

	resetButton.onclick = (e) => {
		e.preventDefault();
		let input1 = document.getElementById("input_field_1");
		let input2 = document.getElementById("input_field_2");
		let input3 = document.getElementById("output_field");
