...
function createRefresh() {
  Phone.innerHTML += `
    <div onclick="window.location.reload()" class="restart">Reset <img style="vertical-align:middle" src="./WeightUnitConversions/assets/refresh_copy.png" alt="restart"/></div>
    `;
}
