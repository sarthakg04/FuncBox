...
function fillInputs(){
  switch (position) {
    case 0:
      ...
      <input type="number" name="raidus" value="" placeholder="r=" id="circle_radius" oninput="calcArea('circle')">
      `;
      break;
      case 1:
      document.getElementById('inputs').innerHTML =`
      <input type="number" name="side" value="" placeholder="s=" id="square__side" oninput="calcArea('square')">
      `;
      break;

      case 2:
      document.getElementById('inputs').innerHTML =`
      <input type="number" name="a" value="" placeholder="a=" id="trapezium__a" oninput="calcArea('trapezium')">
      <input type="number" name="b" value="" placeholder="b=" id="trapezium__b" oninput="calcArea('trapezium')">
      <input type="number" name="h" value="" placeholder="h=" id="trapezium__h" oninput="calcArea('trapezium')">
      `;
      break;
      case 3:
      document.getElementById('inputs').innerHTML =`
      <input type="number" name="base" value="" placeholder="b=" id="triangle__base" oninput="calcArea('triangle')">
        <input type="number" name="height" value="" placeholder="h=" id="triangle__height" oninput="calcArea('triangle')">
      `;
      break;
    default:
