...
var _GRAVITY = 800;
var _MAX_UPWARDS_VELOCITY = -300;
var _UPWARDS_ACCELERATION = -450;
var _TERMINAL_VELOCITY = 400;
var _PIPE_SPACING_Y = 100;
var _TREADMILL_SPEED = -125;

var _CONFIG_WIDTH = 960;
var _CONFIG_HEIGHT = 540;
var _GROUND_Y = _CONFIG_HEIGHT;
...
class FlappyBirdGame {
  ...
  _OnPreload(scene) {
    this._scene = scene;
    this._scene.load.image('sky', 'url(https://ik.imagekit.io/funcboxImages/FlappyBirdGame_assets/sky_KYvJbA8O5ek7.png?updatedAt=1637440438053)');
    this._scene.load.image('bird', 'url(https://ik.imagekit.io/funcboxImages/FlappyBirdGame_assets/bird_LSrWkwFlx4f.png?updatedAt=1637440437801)');
    this._scene.load.image('pipe', 'url(https://ik.imagekit.io/funcboxImages/FlappyBirdGame_assets/pipe_2Io4KAmbUyx7.png?updatedAt=1637440437788)');
  }
