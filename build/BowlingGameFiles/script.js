...
function fill(background) {
  document.getElementsByClassName('GamePad')[0].style.backgroundImage =  'url(FuncBox/BowlingGameFiles/assets/backgrounds/Frame.png)';
}
function createInteractionPad(){
  ...
  <img  id="ball" src="FuncBox/BowlingGameFiles/assets/images/ball.png" class="pin">
  <img id="pin1" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin" >
  <img id="pin2" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin">
  <img id="pin3" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin">
  <img id="pin4" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin">
  <img id="pin5" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin">
  <img id="pin6" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin">
  <img id="pin7" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin">
  <img id="pin8" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin">
  <img id="pin9" src="FuncBox/BowlingGameFiles/assets/images/pin.png" class="pin">
